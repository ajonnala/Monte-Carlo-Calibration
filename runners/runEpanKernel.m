function runEpanKernel()
  ...
  s = strcat('~/private/Monte-Carlo-Calibration/Data/Epan_TH:',int2str(timeHorizon),'strikes:',int2str(numStrikes),'timesteps:',int2str(timeSteps),'numParticles:',int2str(numParticles));
  file = fopen(s, 'a');
